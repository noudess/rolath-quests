...
sub EVENT_SAY {
  if($text=~/hail/i) {
    if(defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 7)) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 1))) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 2))) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 3))) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 4))) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 5))) {
  ...
  if($text=~/continue/i && (defined($qglobals{greatadventures}) && ($qglobals{greatadventures} == 6))) {
...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 67612 => 1)) { # Vahlara's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsj", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67609 => 1)) { # Frizznik's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsb", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67607 => 1)) { # Zajeer's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsn", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67610 => 1)) { # Wijdan's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsl", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67611 => 1)) { # Rytan's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsh", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67614 => 1)) { # Xenaidia's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
    quest::setglobal("writingsm", 1, 5, "F");
  }
  elsif (plugin::check_handin(\%itemcount, 67613 => 1)) { # Kaikachi's Writing
    quest::say("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
