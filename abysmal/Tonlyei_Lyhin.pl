sub EVENT_SAY {
  ...
  if ($text=~/lot of work/i) {
    ...
    if(quest::istaskactivityactive(164,1)) { #Tailoring Freebie Step 2
      ...
      quest::summonitem(58221,20); #Yard of Rough Cloth
      quest::summonitem(58120,20); #Simple Sock Pattern
    }
    if(quest::istaskactivityactive(164,2)) { #Tailoring Freebie Step 3
      ...
      quest::summonitem(58221,20); #Yard of Rough Cloth
      quest::summonitem(58110,20); #Simple Pants Pattern
    }
    if(quest::istaskactivityactive(164,3)) { #Tailoring Freebie Step 4
      ...
      quest::summonitem(58221,20); #Yard of Rough Cloth
      quest::summonitem(58115,20); #Simple Shirt Pattern
    }
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58052 => 1)) { #Muramite Etched Scales
    quest::say("Ah, yes. Here are your scales.");
    quest::summonitem(58053,2); #Preserved Muramite Etched Scales
  }
  elsif (plugin::check_handin(\%itemcount, 58086 => 4) || plugin::check_handin(\%itemcount, 58086 => 3) || plugin::check_handin(\%itemcount, 58086 => 2) || plugin::check_handin(\%itemcount, 58086 => 1)) { #Simple Belt
    quest::say("Ah, yes. Good work.");
  }
  elsif (plugin::check_handin(\%itemcount, 58121 => 4) || plugin::check_handin(\%itemcount, 58121 => 3) || plugin::check_handin(\%itemcount, 58121 => 2) || plugin::check_handin(\%itemcount, 58121 => 1)) { #Simple Socks
    quest::say("Ah, yes. Good work.");
  }
  elsif (plugin::check_handin(\%itemcount, 58109 => 4) || plugin::check_handin(\%itemcount, 58109 => 3) || plugin::check_handin(\%itemcount, 58109 => 2) || plugin::check_handin(\%itemcount, 58109 => 1)) { #Simple Pants
    quest::say("Ah, yes. Good work.");
  }
  elsif (plugin::check_handin(\%itemcount, 58114 => 4) || plugin::check_handin(\%itemcount, 58114 => 3) || plugin::check_handin(\%itemcount, 58114 => 2) || plugin::check_handin(\%itemcount, 58114 => 1)) { #Simple Shirt
    quest::say("Ah, yes. Good work.");
  }
  else {
