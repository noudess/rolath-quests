...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 58048 => 1)) { #Muramite Bile Sack
    quest::say("Ah, yes. Here is your bile.");
    quest::summonitem(58047,2); #Muramite Bile
  }
  elsif (plugin::check_handin(\%itemcount, 58099 => 4) || plugin::check_handin(\%itemcount, 58099 => 3) || plugin::check_handin(\%itemcount, 58099 => 2) || plugin::check_handin(\%itemcount, 58099 => 1)) { #Simple Muramite Blood Contact Poison
    quest::say("Ah, yes. Thank you.");
  }
  elsif (plugin::check_handin(\%itemcount, 58100 => 4) || plugin::check_handin(\%itemcount, 58100 => 3) || plugin::check_handin(\%itemcount, 58100 => 2) || plugin::check_handin(\%itemcount, 58100 => 1)) { #Simple Muramite Blood Injected Poison
    quest::say("Ah, yes. Thank you.");
  }
  elsif (plugin::check_handin(\%itemcount, 58101 => 4) || plugin::check_handin(\%itemcount, 58101 => 3) || plugin::check_handin(\%itemcount, 58101 => 2) || plugin::check_handin(\%itemcount, 58101 => 1)) { #Simple Invader Blood Paralytic
    quest::say("Ah, yes. Thank you.");
  }
  elsif (plugin::check_handin(\%itemcount, 58098 => 4) || plugin::check_handin(\%itemcount, 58098 => 3) || plugin::check_handin(\%itemcount, 58098 => 2) || plugin::check_handin(\%itemcount, 58098 => 1)) { #Simple Invader Blood Atrophic
    quest::say("Ah, yes. Thank you.");
  }
  else {
    quest::say("I do not need this.");
