...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20815 => 1, 20816 => 1, 20814 => 1, 20961 => 1)) { #cleric test of theurgy using djinni aura, efreeti mace, glowing sapphire, saffon spiroc feather
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20817 => 1, 20968 => 1, 20819 => 1, 20818 => 1)) { #cleric test of the weak using efreeti standard, manna nectar, mithril bands, shimmering topaz
