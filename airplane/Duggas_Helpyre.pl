...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20790 => 1, 20967 => 1, 20791 => 1, 20792 => 1)) { #necromancer test of hands using gorgon's head, aged nectar, glowing black pearl, efreeti's great staff
