...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 20930 => 1, 20741 => 1, 20742 => 1)) { #wizard test of concentration using azure tessera, augmentor's gem, grey damask cloak
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20937 => 1, 20743 => 1, 20744 => 1)) { #wizard test of focus using iron disc, ethereal opal, woven skull cap
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20944 => 1, 20745 => 1, 20746 => 1)) { #wizard test of meditation using hyaline globe, sky topaz, high quality raiment
