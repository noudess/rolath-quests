...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 20845 => 1, 20955 => 1, 20842 => 1, 20841 => 1)) { #shaman test of shrink using efreeti war club, djinni statuette, corrosive venom, wooden bands
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20962 => 1, 20843 => 1, 20844 => 1)) { #shaman test of the snake using emerald spiroc feather, bixie essence, spiritualist's ring
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20846 => 1, 20969 => 1, 20848 => 1, 20847 => 1)) { #shaman test of the witch doctor using efreeti war maul, thickened nectar, fire sky ruby, symbol of veeshan
