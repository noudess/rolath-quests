...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 20963 => 1, 20994 => 1, 20995 => 1, 20996 => 1)) {  #rogue test of deception using honeyed nectar, bixie stinger, lightning rod, bloodsky sapphire   
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20949 => 1, 20990 => 1, 20991 => 1)) { #rogue test of stealth using pegasus statuette, prismatic sphere, fine wool cloak
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20935 => 1, 20987 => 1, 20986 => 1)) { #rogue test of cunning using bronze disc, jester's mask, red face paint
