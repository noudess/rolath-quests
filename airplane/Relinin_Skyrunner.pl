...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20853 => 1, 20852 => 1, 20851 => 1)) { #ranger test of defense using fine velvet cloak, harpy tongue, mithril disc
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20854 => 1, 20948 => 1, 20855 => 1)) { #ranger test of the element of earth using dragon-hide mantle, gridelin globe, spiroc earth totem
