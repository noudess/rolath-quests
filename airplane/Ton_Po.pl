...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20796 => 1, 20939 => 1, 20795 => 1)) { #monk test of sight using cracked leather eyepatch, gold disc, tiny ruby
...
quest::ding();
  ...
  elsif(plugin::check_handin(\%itemcount, 20946 => 1, 20798 => 1, 20797 => 1)) { #monk test of speed using adumbrate globe, dove slippers, shimmering opal
