...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 9111 => 1, 9112 => 1, 9113 => 1, 9114 => 1)) {
    ...
    quest::faction(255,15); # Gem Choppers better
    quest::faction(288,15); # Merchants of Ak'Anon better
    quest::faction(333,15); # King Ak'Anon better
    quest::faction(238,-15); # Dark Reflection worse
    quest::exp(10000);
    quest::ding;
