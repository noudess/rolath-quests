...
sub EVENT_ITEM
	...
	if (plugin::takeItems(13198 => 4))
		...
		#:: Give a random reward: 5013 - Rusty Short Sword, 5014 - Rusty Axe, 5015 - Rusty Scythe, 5016 - Rusty Broad Sword, 5019 - Rusty Long Sword, 5020 - Rusty Battle Axe, 12340 - Gnome Glow Rod, 17033 - Tinmizer's Stupendous Contraption, 6027 - Forging Hammer, 13004 - Large lantern, 13077 - Minotaur Horn, 9009 - Small Buckler, 2175 - Small Scarab Helm, 2159 - Small Raw-Hide Leggings, 10016 - Lapis Lazuli, 10018 - Hematite
		quest::summonitem(quest::ChooseRandom(5013, 5013, 5013, 5014, 5014, 5014, 5015, 5015, 5015,  5016, 5016, 5016, 5019, 5019, 5019, 5020, 5020, 5020, 12340, 12340, 17033, 6027, 13004, 13077, 9009, 2175, 2159, 10016, 10018));
		quest::ding();
		#Faction per ZAM
	...
	#:: Match three 13198 - Scrap Metal
		...
		#:: Return three 13198 - Scrap Metal
