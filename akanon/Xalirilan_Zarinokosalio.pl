my $taskid=190;
my $containerid=17256;
my $robeid=9097;
my $titleid=93;
my $pre="Initiate";
my $fix="of the Eldritch Collective";
...
sub EVENT_ITEM
	...
	if (plugin::check_handin(\%itemcount, 9116 => 1, 9117 => 1, 9118 => 1, 9119 => 1))
		{
		quest::say("I knew you could do it $name! You have proven yourself worthy of your god and of your Guild! All the highest ranking officials of the Collective will surely hear of your good deeds. Upon studying these pages a bit further it seems it forms a book of incantations that will aid you in furthering your studies. Please take this magical shard. Good luck!");
