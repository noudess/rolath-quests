#Arch Duke Xog is a Shadowknight guildmaster. We turn our newbie note in to him, and he also gives us the seventh Greenmist quest once we've grown up and gotten that far in the quest series.
