...
sub EVENT_ITEM {
  ...
  if ($cash >= 500) { #5 gold (or equivalent)
    ...
    quest::summonitem(quest::ChooseRandom(2106,2112,2041,13944,2307,13829,1331,17002,7012,8306,10006,10019,5013,5019,5021,5022,6011,5023,7007,7008, 7601, 7691, 59539, 15851, 7681, 59972, 59971)); 
  }
  else {
