...
sub EVENT_SAY {
  ...
  if ($text=~/help/i && $flag == 0) {
    ...
    $mobnpc1->MoveTo(-2681, -4944, 150, 0, 1);
    $mobnpc2->MoveTo(-2703, -4920, 150, 0, 1);
    $mobnpc3->MoveTo(-2697, -4890, 150, 0, 1);
    $mobnpc4->MoveTo(-2707, -4950, 150, 0, 1);
    $mobnpc5->MoveTo(-2710, -4979, 150, 0, 1);
