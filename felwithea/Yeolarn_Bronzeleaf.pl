...
sub EVENT_SAY
	...
	if ($faction > 5)
		{
		quest::say("One such as yourself has nothing to offer the Clerics of Tunare. Remove yourself from this sacred temple!");
		}
	elsif ($text =~ /hail/i)
		{
