...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13536, gold = 2})) then -- dirty green tunic and 2 gold.
		...
		e.other:SummonItem(eq.ChooseRandom(13824, 13824, 13824, 13824, 13824, 13824, 13824, 13334, 13334, 12334)); -- 1/10 chance of wooden heart 9/10 chance of Wooden Shards
		e.other:Ding();
