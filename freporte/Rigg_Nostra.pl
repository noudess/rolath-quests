...
sub EVENT_ITEM 
	...
	if (plugin::check_handin(\%itemcount, 19931 =>1, 19929=>1 )) 
		{
		quest::emote("dumps the axe picks and hardwood shafts into a crate and then passes the crate to you.");
		quest::say("Very good, $name.' Glad to see that Jimble and Grendig were feeling generous enough to donate to our cause. Now give this Filled Crate of Mining Supplies to the man in green standing behind you.");
