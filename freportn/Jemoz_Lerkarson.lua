...
function event_trade(e)
	...
	if(fac < 6 and item_lib.check_turn_in(e.trade, {item1 = 13921})) then
		...
		e.other:Ding();
		e.other:Faction(281,10);
		e.other:Faction(271,-1);
		e.other:Faction(330,-1);
	...
	elseif(fac < 6 and item_lib.check_turn_in(e.trade, {item1 = 12142})) then
		...
		e.other:Ding();
		e.other:Faction(281,20);
		e.other:Faction(271,-3);
		e.other:Faction(330,-3);
		e.other:Faction(362,4);
		e.other:Faction(311,2);
		e.other:AddEXP(5000);
	end
