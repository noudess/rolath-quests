...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 14018})) then -- A spider venom sac
		...
		e.other:Ding();
		-- Faction Verified
		e.other:Faction(281,10); -- Knights of Truth
		e.other:Faction(271,-1); -- Dismal Rage
		e.other:Faction(330,-1); -- Freeport Militia
		e.other:Faction(362,2); -- Priest of Marr
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 13866})) then -- Token of Truth
		...
		e.other:Ding();
		-- Faction Verified
		e.other:Faction(281,100); -- Knights of Truth
		e.other:Faction(271,-15); -- Dismal Rage
		e.other:Faction(330,-15); -- Freeport Militia
		e.other:Faction(362,20); -- Priest of Marr
