...
my $kot_faction=$client->GetModCharacterFactionLevel(281);

if($kot_faction > -200 && plugin::check_handin(\%itemcount,18474 =>1))	{
...
if($kot_faction > -200 && plugin::check_handin(\%itemcount,31492 => 1)) {
