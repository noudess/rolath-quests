...
sub EVENT_ITEM 
	...
	if (plugin::check_handin(\%itemcount, 18737 => 1)) #guild note
		{
		quest::say("Welcome to the Guild, here's your guild tunic. Once you are ready to begin your training please make sure that you see Edwardian Holyblade, he can assist you in developing your hunting and gathering skills. Return to me when you have become more experienced in our art, I will be able to further instruct you on how to progress through your early ranks.");
