...
sub EVENT_ITEM
	...
	if ($faction < 5 && plugin::takeItems(12108 => 2))
		{
	...
	elsif ($faction < 5 && plugin::takeItems(12108 => 1))
		{
	...
	elsif ($faction < 5 && plugin::takeItems(18840 => 1))
		{
	...
	elsif ($faction < 5 && plugin::takeItems(13226 => 1))
		{
