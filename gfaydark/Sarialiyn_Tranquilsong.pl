...
sub EVENT_SAY
	...
	if ($text =~ /young bard of kelethin/i)
		{
...
sub EVENT_ITEM
	...
	if (plugin::check_handin(\%itemcount, 22694 => 2, 27540 => 1))
		{
		quest::say("I never though I would see my lute again. I owe you my sincere thanks $name. Please take this shard of Rolath as a symbol of my gratitude. May it guide you to victory in all of your battles.");
		quest::summonitem("1266");
		#Faction per ZAM
		quest::faction(401, 5);	#Songweavers
