sub EVENT_SAY
	...
	if (   ($text =~ /work/i)
		&& (($class eq "Warrior") || ($class eq "Rogue") || ($class eq "Monk")))
		{
...
sub EVENT_ITEM
	{
	if (plugin::check_handin(\%itemcount, 54062 => 1, 10053 => 1, 54048 => 1))
		{    #melee 1
	...
	if (plugin::check_handin(\%itemcount, 54050 => 1, 54049 => 1, 54033 => 1))
		{                            #melee 2
	...
	if (plugin::check_handin(\%itemcount, 54051 => 1, 54034 => 1))
		{                            #melee 3
	...
	if (plugin::check_handin(\%itemcount, 54040 => 1, 16537 => 1, 10037 => 1))
		{                            #priest 1
	...
	if (plugin::check_handin(\%itemcount, 54042 => 1, 54041 => 1, 54027 => 1))
		{                            #priest 2
	...
	if (plugin::check_handin(\%itemcount, 54043 => 1, 54028 => 1))
		{                            #priest 3
	...
	if (
		plugin::check_handin(\%itemcount, 54035 => 1, 54058 => 1, 54060 => 1, 54056 => 1))
		{                            #melee 4
	...
	if (
		plugin::check_handin(\%itemcount, 54029 => 1, 54059 => 1, 54061 => 1, 54057 => 1))
		{                            #priest 4
		quest::summonitem(54039);
		quest::exp(60000);
		quest::ding();
