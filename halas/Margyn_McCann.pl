...
sub EVENT_ITEM
	{
	if($faction < 5 && plugin::check_handin(\%itemcount, 13729 => 1)) #Barbarian Head
		{
		...
		quest::summonitem(15279); #Spell:Spirit of Bear
		}
		...
		quest::exp(15);        # Give exp for turning in quest
		quest::ding();
		}
