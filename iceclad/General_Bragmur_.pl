...
sub EVENT_WAYPOINT_ARRIVE {
   ...
   if ($wp eq "13") {
      ...
      quest::spawn2(110097, 0, 0, 7518.8, -3539.8, 164.0, 190.2);
      quest::spawn2(110097, 0, 0, 7536.8, -3525.8, 163.2, 250.8);
      quest::spawn2(110097, 0, 0, 7555.5, -3530.8, 162.2, 311.2);
      quest::spawn2(110097, 0, 0, 7512.5, -3575.6, 165.3, 65.6);
   }
   # Ambush 2
   elsif($wp eq "20") {
      # 110120 - Frost Giant Skrimisher (level 54)
      quest::spawn2(110120, 0, 0, 7243.8, -2153.7, 150.2, 221.6);
      quest::spawn2(110120, 0, 0, 7211.8, -2204.5, 145.6, 139.8);
      quest::spawn2(110120, 0, 0, 7254.1, -2246.1, 147.5, 17.8);
      quest::spawn2(110120, 0, 0, 7324.7, -2196.4, 153.9, 376.2);
   }
   # Ambush 3
   elsif($wp eq "33") {
      # 110112 - Commander Kvarid
      # 110121 - Frost Giant Skirmisher (level 55)
      quest::spawn2(110112, 0, 0, 5923.9, -1015.7, 162.5, 258.6);
      quest::spawn2(110121, 0, 0, 5864.8, -1063.2, 157.7, 133.2);
      quest::spawn2(110121, 0, 0, 5894.9, -1110.1, 160.6, 43.2);
      quest::spawn2(110121, 0, 0, 5973.3, -1041.8, 163.0, 355.2);
   }
   # Ambush 4
   elsif($wp eq "68") {
      # 110122 - Kromrif trackin wolf (second version)
      quest::spawn2(110122, 0, 0, 2265.1, 1530.2, 60.1, 285.2);
      quest::spawn2(110122, 0, 0, 2249.0, 1536.2, 56.0, 246.8);
      quest::spawn2(110122, 0, 0, 2234.1, 1530.7, 52.4, 224.8);
      quest::spawn2(110122, 0, 0, 2220.9, 1500.8, 50.4, 175.8);
      quest::spawn2(110122, 0, 0, 2242.6, 1458.6, 52.0, 38.6);
   }
   # Ambush 5
   elsif($wp eq "80") {
      # 110121 - Frost Giant Skirmisher (level 55)
      # 110109 - Commander Vjorik
      quest::spawn2(110109, 0, 0, 2695.9, 3725.1, 249.2, 256.8);
      quest::spawn2(110121, 0, 0, 2678.2, 3719.1, 250.3, 178.8);
      quest::spawn2(110121, 0, 0, 2709.9, 3720.5, 245.5, 330.8);
      quest::spawn2(110121, 0, 0, 2711.9, 3707.5, 242.0, 385.8);
      quest::spawn2(110121, 0, 0, 2678.7, 3690.9, 245.7, 70.8);
      quest::spawn2(110121, 0, 0, 2666.9, 3735.2, 247.8, 190.2);
   }
   # Hail gnome camp
   elsif($wp eq "91") {
...
sub EVENT_TIMER {
   ...
   if ($timer eq "bragmur3") {
      ...
      quest::spawn2(110119, 0, 0, 1309.9, 4571.0, 72.6, 49.2);
      # Avatar of Below
   }
}
