...
sub EVENT_TIMER {
  if($timer eq "SpawnAdds") {
    ...
    $entity_list->GetClientByName($TopHate)->GMMove(0, 65, -2, 262);
  }
}
...
sub EVENT_DEATH {
  ...
  quest::spawn2(296027,0,0,90,-515,-27,128);
...
sub SPAWN_MY_ADDS {
  quest::spawn2(quest::ChooseRandom(296025,296026),0,0,357,-549,-3,126); 
  quest::spawn2(quest::ChooseRandom(296025,296026),0,0,357,-451,-2,126);
  quest::spawn2(quest::ChooseRandom(296025,296026),0,0,285,-493,-2,126);
}
