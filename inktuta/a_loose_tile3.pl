...
sub EVENT_ENTER {
  ...
  quest::spawn2(296048,0,0,-533,-737,-122,128);
  quest::spawn2(296048,0,0,-533,-798,-122,128);
  quest::spawn2(296048,0,0,-454,-798,-122,384);
  quest::spawn2(296048,0,0,-454,-737,-122,384);
  $npc->Depop(1);
