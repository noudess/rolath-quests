    ...
    if(!defined $qglobals{$instid.'_inktuta'}) {
      ...
      if(!defined $qglobals{$instid.'_inktuta_status'}) { #check for their instance global to exist
        ...
        if(!$entity_list->GetMobByNpcTypeID(296023)){ 
          quest::spawn2(296023,0,0,353,-656,-2,388); #Servant_of_Keleldrix
        }
      } elsif($qglobals{$instid.'_inktuta_status'} == 1) { #Kelekdrix spawned
        quest::spawn2(296024,537949,0,480,-416,4,112); #Kelekdrix,_Herald_of_Trushar
      } elsif($qglobals{$instid.'_inktuta_status'} == 2) {
        OPEN_DOORS(1);
        quest::spawn2(296027,0,0,165,-496,-27,128); #Mimezpo_the_Oracle
      } elsif($qglobals{$instid.'_inktuta_status'} == 3) {
        OPEN_DOORS(1);
        quest::spawn2(296030,0,0,-274,-531,-52,250); #a_rambling_exile
        quest::spawn2(296033,0,0,-557,-237,-2,126); #a_confused_exile
        quest::spawn2(296035,0,0,-406,-552,-77,124); #an_incoherent_exile
        quest::spawn2(296036,0,0,-355,-554,-77,380); #an_irrational_exile
      } elsif($qglobals{$instid.'_inktuta_status'} == 4) {
        OPEN_DOORS(2);
      } elsif($qglobals{$instid.'_inktuta_status'} == 5) {
        OPEN_DOORS(2);
        REMOVE_LOOSE_TILES(1);
        quest::spawn2(296048,0,0,-454,-500,-72,384); #a_clay_monolith
        quest::spawn2(296048,0,0,-494,-401,-72,256); #a_clay_monolith
        quest::spawn2(296048,0,0,-533,-500,-72,108); #a_clay_monolith
      } elsif($qglobals{$instid.'_inktuta_status'} == 6) {
        OPEN_DOORS(2);
        REMOVE_LOOSE_TILES(2);
        quest::spawn2(296048,0,0,-533,-580,-97,128); #a_clay_monolith
        quest::spawn2(296048,0,0,-454,-649,-97,384); #a_clay_monolith
        quest::spawn2(296048,0,0,-533,-649,-97,128); #a_clay_monolith
        quest::spawn2(296048,0,0,-454,-580,-97,384); #a_clay_monolith
      } elsif($qglobals{$instid.'_inktuta_status'} == 7) {
        OPEN_DOORS(2);
        REMOVE_LOOSE_TILES(3);
        quest::spawn2(296048,0,0,-533,-737,-122,128); #a_clay_monolith
        quest::spawn2(296048,0,0,-533,-798,-122,128); #a_clay_monolith
        quest::spawn2(296048,0,0,-454,-798,-122,384); #a_clay_monolith
        quest::spawn2(296048,0,0,-454,-737,-122,384); #a_clay_monolith
        ...
        quest::spawn2(296048,0,0,-296,-869,-122,256); #a_clay_monolith
        quest::spawn2(296048,0,0,-371,-869,-122,256); #a_clay_monolith
        quest::spawn2(296052,0,0,-166,-911,-127,388); #Noqufiel
      } elsif($qglobals{$instid.'_inktuta_status'} == 9) {
        OPEN_DOORS(3);
        REMOVE_LOOSE_TILES(4);
        quest::spawn2(296065,0,0,-55,-653,-127,242); #True_Image_of_Noqufiel
        quest::spawn2(296066,0,0,-103,-652,-127,250); #Mirror_Image_of_Noqufiel
      } elsif($qglobals{$instid.'_inktuta_status'} == 10) {
        #true image of noqufiel defeated but jomica not talked to.
        OPEN_DOORS(3);
        REMOVE_LOOSE_TILES(4);
        quest::spawn2(296071,0,0,-55, -653, -127, 242); #Jomica_the_Unforgiven
        ...
        OPEN_DOORS(3);
        REMOVE_LOOSE_TILES(4);
        quest::spawn2(296067,0,0,-63,-600,-127,256);  #an ancient sentinel
      }
...
sub KICK_ALL_PLAYERS {
  ...
  foreach $pc ($entity_list->GetClientList()) {
    $pc->MovePC(295, -1014, -1345, -490, 256);
  }
}
