...
sub EVENT_ITEM
	...
	if ($faction < 7 && plugin::takeItems(13931 => 4))
		{
		...
		#:: Reward a 2113 - Small Tattered Skullcap, 2114 - Small Tattered Mask,
		#   2115 - Small Tattered Gorget, 2117 - Small Tattered Shoulderpads, 
		#   2119 - Small Tattered Belt, 2121 - Small Tattered Wristbands, 
		#	2122 - Small Tattered Gloves
	...
	if ($faction < 7 && plugin::takeItems(13741 => 1, 13740 => 1))
		{
		...
		#:: Reward a 3090 - Bloodforge Helm, 3091 - Bloodforge Mail, 
		#:: 3092 - Bloodforge Armplates, 3093 - Bloodforge Bracers, 
		#:: 3094 - Bloodforge Gauntlets, 3095 - Bloodforge Legplates, 
		#:: 3096 - Bloodforge Boots
	...
	elsif ($faction < 7 && plugin::takeItems(12136 => 1))
		{
