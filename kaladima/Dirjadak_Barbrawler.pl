...
sub EVENT_ITEM
    ...
    if ( plugin::check_handin( \%itemcount, 28064 => 2, 28063 => 1 ) )
        {
        quest::say("I surely knew when I saw ye that ye would grow into a fine warrior of Brell and make me very proud! Well ye have done that indeed and I cannot tell ye how happy I am to have me stein back. Please take this magical shard and may it guard you well in all of yer adventures to come. You have done well . Aye.");
