sub EVENT_SAY { 
	...
	if($text=~/truth/i){
		...
		quest::signalwith(160111,1,2500);
	}
	if($text=~/phenic/i){
	...
	if($text=~/proof/i){
		...
		quest::signalwith(160111,2,2500);
		quest::summonitem(29899);
	}
	if($text=~/tsaph/i){
		...
		quest::signalwith(160111,3,2500);
	}
	if($text=~/exist/i){
	...
	if($text=~/exodus/i){
		...
		quest::signalwith(160111,5,2500);
	}
}
...
sub EVENT_SIGNAL {
	if($signal == 1) {
		...
		quest::signalwith(160111,4,5000);
	}
	if($signal == 2) {
	...
	if($signal == 4) {
		...
		quest::signalwith(160111,7,5000);
		quest::start(23);
	}
	if($signal == 5) {
...
sub EVENT_WAYPOINT_ARRIVE {
	if($wp == 9) {
		quest::signalwith(160111,8,5000);
	}
}
