...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (plugin::check_hasitem($client, 52125)) { # scale of the cragbeast queen
      quest::say("Unbelievable! Those are authentic ancient cragbeast scales. Why, they're absolutely humongous. Some of the scales are a bit charred or damaged in places, hmm. She chuckles, The beast didn't go down without a fight, I take it? There are enough scales in good shape to fashion a sash. I could do so with the right [materials], if you wish."); 
    }
    else {
