...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 19578 => 1, 19577 => 1, 13060 => 1)) {
    ...
    quest::say("You have slain enemies of our order. Wear your shard with pride.");
  }
  else {
