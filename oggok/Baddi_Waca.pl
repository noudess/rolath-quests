sub EVENT_SAY 
	...
	if($text =~/tome/i) 
		{
		quest::say("Aha!  Tomes!  Be checking dis information.");
		...
		$Indent -Move your cursor with the tome still on it over to your guildmaster and [$Yel left-click </c>] on him/her. <br>
		...
		Remember to stock up on components if you wish to use your new skill and create some throwing axes.  You can visit the Berserker Tome Merchants in your home town to buy more tomes and components.");
		}
	}
