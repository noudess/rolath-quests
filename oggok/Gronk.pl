...
my $taskid=83;
my $containerid=51377;
my $bracerid=51309;
my $robeid=51313;
my $titleid=50;
my $pre="Craknek Warrior";
my $fix="";
...
sub EVENT_ITEM 
	...
	if (plugin::check_handin(\%itemcount, 55206 => 1)) 
		{
		quest::say("What be dis??! No, my preshus Hermina!!! Why dis have to happen? Huh? No, Gronk not crying!!!! Take dis for da help and leave Gronk for now.");
