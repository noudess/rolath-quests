...
# Custom quest - nothing to do with this mob.
# Just needed someone to catch the cross zone signal
sub EVENT_SIGNAL
	{
	quest::spawn2(101070, 0,0, -804, 749, -24, 8);
	quest::signalwith(101070, $signal);
	}
