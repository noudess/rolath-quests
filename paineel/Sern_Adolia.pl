...
sub EVENT_ITEM 
	{
	if ($faction <= 7) # We know he returns items at dubiius
		{
		if (plugin::check_handin(\%itemcount, 18019 => 1))
			{
			quest::say("You are welcomed into the fold.  Now go out, and prove yourself, young one.  You have much to learn about the Dark Truth. Once you are ready to begin your training please make sure that you see Sadorno Chomosh, he can assist you in developing your hunting and gathering skills.");
		...
		{
		quest::say("Meager contributions will get you nowhere.  You must earn your place in the temple through mastery of fright.");
