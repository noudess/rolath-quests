...
sub EVENT_TIMER 
{
	if($timer == 30) {
    		...
    		{
			quest::spawn2(215460,0,0,-356.8,591.3,436.3,418.8); 
			quest::spawn2(215460,0,0,-282.1,663.4,442.4,459.6); 
			quest::spawn2(215460,0,0,-168.5,782.1,434.2,340.4); 
			quest::spawn2(215460,0,0,-301.7,832.8,433.6,269.6); 
			quest::spawn2(215460,0,0,-505.8,892.7,434.7,250.8); 
			quest::spawn2(215460,0,0,-611.5,782.7,434.9,123.2); 
			quest::spawn2(215460,0,0,-641.2,608.2,439.1,80.4); 
			quest::spawn2(215460,0,0,-562.6,493.1,436.8,49.8); 
			quest::spawn2(215460,0,0,-343.5,476.7,433.6,489); 
			quest::spawn2(215460,0,0,-220.8,528.4,433.6,438.2); 
			quest::spawn2(215460,0,0,-160.8,609.6,435,413.8); 
			quest::spawn2(215460,0,0,-435.5,773.5,434.1,239.2); 
			quest::spawn2(215460,0,0,-531.9,689.2,444,178); 
			quest::spawn2(215460,0,0,-363.4,747.4,435.2,310.8); 
			quest::spawn2(215460,0,0,-480.3,574,435.6,37.6); 
			quest::spawn2(215456,0,0,-443.7,642.6,435.1,117.6); 
...
sub EVENT_SIGNAL 
{
	if ($signal == 1 && defined($qglobals{dust_event_start}) && !defined($qglobals{dust_done})) 
	{
		...
		$counterone+=1;
     	...
     	{
		quest::spawn2(215475,0,0,1671,527,356,384);
		quest::depop(215046);
	}
