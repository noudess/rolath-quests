...
#
# Zone: PoEarthA
# MOB Name: Verkerchiki Trap
# MOB ID Number: 218106
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218052,0,0,$x,$y,$z,$h); # An Ancient Vekerchiki Champion
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218025,0,0,$x,$y,$z,$h);# A Vekerchiki Warrior
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218047,0,0,$x,$y,$z,$h);# A Vekerchiki Drone
