...
# File Modified By: Tunare:0, Karana:2 (Manchester United:1).
#
# Zone: PoEarthA
# MOB Name: Croc Trap
# MOB ID Number: 218104
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218100,0,0,$x,$y,$z,$h);# A prismatic basilisk
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218006,0,0,$x,$y,$z,$h);# A Needlescale basilisk
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218080,0,0,$x,$y,$z,$h);# A Needlescale Hatchling
