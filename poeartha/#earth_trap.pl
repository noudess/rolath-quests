...
# File Modified By: Ninja Donkeys
#
# Zone: PoEarthA
# MOB Name: Earth Trap
# MOB ID Number: 218108
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218115,0,0,$x,$y,$z,$h); # The Living Earth
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218027,0,0,$x,$y,$z,$h);# An Earthern Crusader
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218097,0,0,$x,$y,$z,$h); # A Magical Collection of Dust
