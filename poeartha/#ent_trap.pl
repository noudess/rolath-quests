...
# File Modified By: The Foot. The Foot. The foot is on fire.
#
# Zone: PoEarthA
# MOB Name: Ent Trap
# MOB ID Number: 218105
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218081,0,0,$x,$y,$z,$h);# Tribal Leader Diseranon
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218008,0,0,$x,$y,$z,$h); # A Fearsome Earthcrafter
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218026,0,0,$x,$y,$z,$h);# An Earth Initiate
