...
# File Modified By: Bob's a Ginger
#
# Zone: PoEarthA
# MOB Name: Geonid Trap
# MOB ID Number: 218112
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218074,0,0,$x,$y,$z,$h);# Glimmerstone
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218074,0,0,$x,$y,$z,$h);# Glimmerstone - PH NEEDS TO BE CONFIRMED
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218046,0,0,$x,$y,$z,$h); # A young cave geonid
