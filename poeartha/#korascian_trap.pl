...
#
# Zone: PoEarthA
# MOB Name: Korascian Trap
# MOB ID Number: 218110
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218065,0,0,$x,$y,$z,$h);# A Korascian Warlord
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218004,0,0,$x,$y,$z,$h);# A Korascian Hunter
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218048,0,0,$x,$y,$z,$h);# A Young Frog
