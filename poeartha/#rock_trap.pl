...
# File Modified By: Care Bear Daddy
#
# Zone: PoEarthA
# MOB Name: Rock trap
# MOB ID Number: 218103
#
...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218101,0,0,$x,$y,$z,$h);# A Pristine Gem Golem
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218075,0,0,$x,$y,$z,$h);# NPC A Small Rockmonster
