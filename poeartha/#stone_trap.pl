...
sub EVENT_ENTER {
  ...
  # NOTE: It says greater than or equal to 4 because we started at zero, not one.
    if($TripCounter >= 4) {
      ...
      if($chance > 70) {
        ...
        quest::spawn2(218116,0,0,$x,$y,$z,$h);# Galsinak Earthwalker
        ...
        # Spawn the PH
        # He will spawn at this NPC's current X,Y,Z,H coordinates
        quest::spawn2(218016,0,0,$x,$y,$z,$h);# A stone Abomination
  ...
  # If we have been tripped less than 5 times, spawn a trash mob
    ...
    # He will spawn at this NPC's current X,Y,Z,H coordinates
    quest::spawn2(218036,0,0,$x,$y,$z,$h);# An Unfinished Stonewalker
