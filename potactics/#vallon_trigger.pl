...
sub EVENT_SIGNAL {
	...
	if ($signal == 3) {
		...
		quest::spawn2(214110,0,0,-606,1999,195.1,261.8);	# Fake Vallon
		quest::spawn2(214110,0,0,-666,1999,195.1,261.8);	# Fake Vallon
		quest::spawn2(214110,0,0,-636,1969,195.1,261.8);	# Fake Vallon
		quest::spawn2(214110,0,0,-636,2029,195.1,261.8);	# Fake Vallon
		quest::spawn2(214083,0,0,-636,1999,195.1,261.8);	# Real Vallon
