...
sub EVENT_SPAWN {
    ...
    quest::spawn2(223160,0,0,80,1645,495,128); #earth door
    quest::spawn2(223203,0,0,98,1645,495,390);
    quest::spawn2(223161,0,0,80,1355,495,128); #air door
    quest::spawn2(223204,0,0,98,1355,495,390);
    quest::spawn2(223162,0,0,80,1109,495,128); #undead door
    quest::spawn2(223205,0,0,98,1109,495,390);
    quest::spawn2(223202,0,0,80,868,495,128); #water door
    quest::spawn2(223207,0,0,98,868,495,390);
    quest::spawn2(223201,0,0,80,574,495,128); #fire door
    quest::spawn2(223206,0,0,98,574,495,390);
...
sub EVENT_SIGNAL {
  if ($signal == 10020) {
    ...
    quest::spawn_condition(potimeb,10,1);
    quest::spawn2(223134,0,0,262,1644,493,385);
    quest::spawn2(223118,0,0,262,1354,493,385);
    quest::spawn2(223127,0,0,262,1109,493,385);
    quest::spawn2(223096,0,0,262,869,493,385);
    quest::spawn2(223146,0,0,262,574,493,385);
}
  if ($signal == 10030) {
    $IIacounter += 1;
}
