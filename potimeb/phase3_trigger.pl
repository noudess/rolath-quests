...
sub EVENT_SPAWN {
    ...
    quest::spawn2(223209,0,0,458,709,495,128); #doors
    quest::spawn2(223208,0,0,458,1101,495,128);
    quest::spawn2(223210,0,0,458,1502,495,128);
    quest::spawn2(223010,0,0,1280,1010,359.38,390); #non target nameds
    quest::spawn2(223011,0,0,1280,1030,359.38,390);
    quest::spawn2(223012,0,0,1260,1250,359.38,390);
    quest::spawn2(223013,0,0,1260,1270,359.38,390);
    quest::spawn2(223014,0,0,1280,1210,359.38,390);
    quest::spawn2(223015,0,0,1280,1190,359.38,390);
    quest::spawn2(223016,0,0,1260,970,359.38,390);
    quest::spawn2(223017,0,0,1260,950,359.38,390);
    quest::spawn2(223018,0,0,1300,1070,359.38,390);
    quest::spawn2(223019,0,0,1300,1090,359.38,390);
    quest::spawn2(223020,0,0,1300,1130,359.38,390);
    quest::spawn2(223021,0,0,1300,1150,359.38,390);
    quest::spawn2(223022,0,0,1230,1330,359.38,350);
    quest::spawn2(223023,0,0,1230,1310,359.38,350);
    quest::spawn2(223155,0,0,1250,1135,359.5,384);
    quest::spawn2(223156,0,0,1250,1085,359.5,384);
	...
	quest::spawn2(223996, 0, 0, 891, 1111, 493, 384); #phase2_flag
...
sub EVENT_SIGNAL {
  if ($signal == 11018) { #spawn first 2 nameds
    ...
    quest::spawn2(223009,0,0,1250,1085,359.5,384);
    quest::spawn2(223008,0,0,1250,1135,359.5,384);
}
  if ($signal == 11010) { 
    $namedI += 1;
}
  if ($namedI == 2) { 
    ...
    quest::spawn2(223017,0,0,1250,1085,359.5,384); #pop targetable nameds in new locations
    quest::spawn2(223016,0,0,1250,1135,359.5,384);
    $namedI = 0;
    $namedII = 0;
  ...
  if ($signal == 11028) { #spawn second 2 nameds
    ...
    quest::spawn2(223024,0,0,1250,1085,359.5,384);
    quest::spawn2(223025,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedII == 2) {
    ...
    quest::spawn2(223023,0,0,1250,1085,359.5,384);
    quest::spawn2(223022,0,0,1250,1135,359.5,384);
    $namedII = 0;
    $namedIII = 0;
} 
  if ($signal == 11038) { #3
    ...
    quest::spawn2(223031,0,0,1250,1085,359.5,384);
    quest::spawn2(223032,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedIII == 2) {
    ...
    quest::spawn2(223012,0,0,1250,1085,359.5,384);
    quest::spawn2(223013,0,0,1250,1135,359.5,384);
    $namedIII = 0;
    $namedIV = 0;
} 
  if ($signal == 11048) { #4
    ...
    quest::spawn2(223038,0,0,1250,1085,359.5,384);
    quest::spawn2(223037,0,0,1250,1135,359.5,384);
  ...
  if ($namedIV == 2) {
    ...
    quest::spawn2(223010,0,0,1250,1085,359.5,384);
    quest::spawn2(223011,0,0,1250,1135,359.5,384);
    $namedIV = 0;
    $namedV = 0;
} 
  if ($signal == 11058) { #5
    ...
    quest::spawn2(223047,0,0,1250,1085,359.5,384);
    quest::spawn2(223046,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedV == 2) {
    ...
    quest::spawn2(223015,0,0,1250,1085,359.5,384);
    quest::spawn2(223014,0,0,1250,1135,359.5,384);
    $namedV = 0;
    $namedVI = 0;
} 
  if ($signal == 11068) { #6
    ...
    quest::spawn2(223050,0,0,1250,1085,359.5,384);
    quest::spawn2(223051,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedVI == 2) {
    ...
    quest::spawn2(223020,0,0,1250,1085,359.5,384);
    quest::spawn2(223021,0,0,1250,1135,359.5,384);
    $namedVI = 0;
    $namedVII = 0;
} 
  if ($signal == 11078) { #7
    ...
    quest::spawn2(223058,0,0,1250,1085,359.5,384);
    quest::spawn2(223057,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedVII == 2) {
    ...
    quest::spawn2(223018,0,0,1250,1085,359.5,384);
    quest::spawn2(223019,0,0,1250,1135,359.5,384);
  ...
  if ($signal == 11088) { #last 2 nameds
    ...
    quest::spawn2(223066,0,0,1250,1085,359.5,384);
    quest::spawn2(223065,0,0,1250,1135,359.5,384);
}
  ...
  if ($namedVIII == 2) { #spawn golems
    quest::spawn2(223073,0,0,1492,1110,374.1,391);
    quest::spawn2(223074,0,0,1563,1110,374.1,391);
    $namedVIII = 0;
    $namedIX = 0;
} 
  if ($signal == 11090) { 
