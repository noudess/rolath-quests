...
sub EVENT_SPAWN {
    ...
    quest::spawn2(223098,0,0,-299,-297,23.3,62); #Fake Bertoxxulous
    quest::spawn2(223165,0,0,-257,255,6,203); #Fake Cazic
    quest::spawn2(223000,0,0,303.3,306,13.3,323); #Fake Innoruuk
    quest::spawn2(223001,0,0,264,-279,18.75,435); #Fake Rallos
	...
	quest::spawn2(223998, 0, 0, 214, 1, 348, 384);#phase4_flag
...
sub EVENT_SIGNAL {
  if ($signal == 13080) { #depop fake and pop the real gods
    ...
    quest::spawn2(223142,0,0,-299,-297,23.3,62); #Real Bertoxxulous
    quest::spawn2(223166,0,0,-257,255,6,203); #Real Cazic
    quest::spawn2(223167,0,0,303.3,306,13.3,323); #Real Innoruuk
    quest::spawn2(223168,0,0,264,-279,18.75,435); #Real Rallos
}
  if ($signal == 13010) {
    $godcounterII += 1;
}
