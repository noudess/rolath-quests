...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 15809 => 1)) { #Note to Yuanda
    ...
    quest::spawn2(12183, 0, 0, $x-18, $y-35, $z,   256); #a snarling werewolf (normal)
    quest::spawn2(12183, 0, 0, $x+18, $y-35, $z,   256); #a snarling werewolf (normal)
    quest::spawn2(12183, 0, 0, $x-35, $y+10, $z+5, 256); #a snarling werewolf (normal)
    quest::spawn2(12183, 0, 0, $x+35, $y+10, $z,   256); #a snarling werewolf (normal)
    quest::spawn2(12184, 0, 0, $x,    $y+35, $z,   256); #a snarling werewolf (high)
    $npc->Depop(1);
  }
  else {
