...
sub EVENT_SAY
{
 ...
 if($text=~/Trintle/i)
	{
	quest::say("Brotehr Trintle is my fellow disciple.  He is best known for his mission ro aid the beggars living in the sewers of Qeynos.  He spend a month down there.  He came back a new man. He is quite an extraordinary young cleric.");
	}
}
...
if(plugin::check_handin(\%itemcount, 13910 =>1 ))
	...
	quest::faction(219, 2); #Antonious Bayle
	quest::exp(50);
	quest::ding();
