function event_say(e)
	...
	elseif(e.message:findi("mira sayer")) then
	...
	elseif(e.message:findi("gnoll loving weakling who isn't fit to comb")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 13122})) then
		...
		e.other:Faction(223,-20,0); -- Circle of Unseen
		e.other:Faction(291,3,0); -- Merchants
		e.other:Faction(230,-3,0); -- Corrupt Guards
		e.other:Faction(262,3,0); -- Guards
		e.other:Faction(273,-2,0); -- Kane Baye
		e.other:AddEXP(500);
