...
sub EVENT_ITEM {
    if ($item1=="18712") {
        quest::say("Greetings, and welcome to the Silent Fist Clan. Don our guild tunic, purge your mind and soul, and begin your lifelong devotion to the Clan. Brother Esrinap will introduce you to our lifestyle and begin your training. Be sound, allow your spirit to open up and guide you. You may also see Seta about getting you something to wear.");
        quest::summonitem("13507");
        # Silent Fist Clan faction
        quest::faction(309,"100");
