...
sub EVENT_ITEM {
  if($faction <= 3 && plugin::check_handin(\%itemcount, 10112 => 1, 13165 => 1, 13166 => 1, 13167 => 1)) { #Orange Headband, Head of Ghanex Drah, Dareb's Skull, Head of Shen
  ...
  elsif($faction <= 3 && plugin::check_handin(\%itemcount, 10113 => 1, 13168 => 1, 13169 => 1, 3000 => 1)) { #Red Headband, Skull of Jhen`Tra, Dagger of Marnek, Zaharn's Coronet
