...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12204})) then
		...
		e.other:Ding();
		e.other:Faction(291,20);
		e.other:Faction(223,-4);
		e.other:Faction(219,3);
		e.other:Faction(229,2);
		e.other:Faction(262,4);
		e.other:AddEXP(500);
	elseif(item_lib.check_turn_in(e.trade, {item1 = 8357,item2 = 8356,item3 = 5416})) then
		...
		e.other:Ding();
		e.other:Faction(291,200,0);
		e.other:Faction(223,-40,0);
		e.other:Faction(219,30,0);
		e.other:Faction(229,20,0);
		e.other:Faction(262,40,0);
		e.other:AddEXP(500);
	end
