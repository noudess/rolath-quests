...
sub EVENT_SIGNAL {
   if($signal == 0) { #signal 0 is from the Councilman Sislano
      ...
      quest::spawn2(281129,0,0,-522,-35,-8,450);
      quest::spawn2(281129,0,0,-557,-51,-8,506);
      quest::spawn2(281129,0,0,-593,-35,-8,56);
      quest::spawn2(281129,0,0,-607,0,-8,132);
      quest::spawn2(281129,0,0,-593,35,-8,188);
   }
   ...
   if($counter == 6) {     
      ...
      quest::spawn2(281130,0,0,-521,36,-8,332);
      quest::spawn2(281130,0,0,-507,0,-8,386);
      quest::spawn2(281128,0,0,-522,-35,-8,450);
      quest::spawn2(281128,0,0,-593,-35,-8,56);
      quest::spawn2(281128,0,0,-607,0,-8,132);
   }
   ...
   if($counter == 18) {
      ...
      quest::spawn2(281131,0,0,-521,36,-8,332);
      quest::spawn2(281131,0,0,-507,0,-8,386);
   }   

   if($counter == 21) {
      quest::stoptimer(2);
      quest::spawn2(281125,0,0,-556,0,-3,508);
   }
 
   if($signal == 2) { #from death of Kabeka_Kret
      quest::spawn2(281061,0,0,-507,0,-8,386);  #4 snakes
      quest::spawn2(281061,0,0,-557,-51,-8,506);
      quest::spawn2(281061,0,0,-607,0,-8,132);
      quest::spawn2(281061,0,0,-557,50,-8,254);
   }
   
   if($counter == 26) {
      quest::spawn2(281126,0,0,-556,0,-3,508);   
   }
...
sub EVENT_TIMER {
  if ($timer == 1) {
   ...
   if ($timer == 2) {
     quest::stoptimer(2);
     quest::spawn2(281030,0,0,-556,0,-3,508);
     }
