...
sub EVENT_ITEM
	...
	if ($gold == 10)
		{
		quest::say("Wonderful, we will use this coin well!");
	...
	elsif ($faction <=4 && plugin::check_handin(\%itemcount, 13936 => 1))
		{
		quest::say("Greetings Deputy!  Here is your recharged ring!");
