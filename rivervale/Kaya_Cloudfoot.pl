...
if(plugin::check_handin(\%itemcount, 19688 => 1))
	{
	quest::say("You have done well, $name. The Teir'Dal must learn that there are those among us Halflings who are willing to do what we must for the defense of our more humble commoners. Take this Dull Bravefoot Short Sword to the forge at Tagglefoot's Farm and sharpen it with a sharpening stone. It may take several attempts if you are unfamiliar with the process. Once that is done, present the blade and a large snake skin to Bodbin Gimple and he will put the finishing touches on the sword.");
	quest::summonitem(19625);
	# Faction verified
	quest::faction(286,10);
	quest::faction(292,1);
	quest::faction(355,1);
	quest::faction(324,-1);
	}
	...
	{
	quest::say("Karana smiles upon you, young $name! Take this tunic to keep you warm through the storms you must face. There is evil encroaching upon the lands of Karana's faithful. The wicked minions of Bertoxxulous and the Teir`Dal children of Hate corrupt the lands to the west and east, and the Deathfist Clan of Orcs are waging war on this region while destroying the wilderness for lumber and stone. It is Karana's will that we defend our lands and way of life from these evil threats. When you are ready to begin adventuring, I will be happy to advise you on how to help us deal with the [evil forces].");
