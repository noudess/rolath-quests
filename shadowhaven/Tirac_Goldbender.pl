sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Thank you for coming to Shandeling's Casino! If you would like to try your luck at a game of chance, I can offer you a game of King's Court with prizes best suited for any enchanter, magician, necromancer, or wizard. To play, buy a token from any of the waitresses and hand it to me when ready."); 
}
 }
...
#stat food
elsif($itemcount{66616} && $random_result>601 && $random_result<1300){  quest::summonitem(quest::ChooseRandom(66607,66608,66609));
