...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 30625 => 4)) {
    ...
    quest::say("Oh wow! This is just what I was hoping for. Thank you so much! You must be a real good friend to Saren to have her make you these, she never makes freshly squeezed nectar unless she really likes someone. You have a kind heart Khatzhana. Please take this with you as a token of my friendship.'' Chialle smiles as she hands $name a shimmering emberstone ring"); 
    quest::exp(4000);
    quest::ding();
  }
  else {
