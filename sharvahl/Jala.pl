...
if ($itemcount{1001} >= 1 || $itemcount{1002} >= 1 || $itemcount{1003} >= 1 || $itemcount{1004} >= 1 || $itemcount{1005} >= 1 || $itemcount{1006} >= 1 || $itemcount{1007} >= 1 || $itemcount{1008} >= 1 || $itemcount{1009} >= 1 || $itemcount{1010} >= 1 || $itemcount{1011}>=1  || $itemcount{1012}>= 1){
plugin::check_handin(\%itemcount,1001=>1);
plugin::check_handin(\%itemcount,1002=>1);
plugin::check_handin(\%itemcount,1003=>1);
plugin::check_handin(\%itemcount,1004=>1);
plugin::check_handin(\%itemcount,1005=>1);
plugin::check_handin(\%itemcount,1006=>1);
plugin::check_handin(\%itemcount,1007=>1);
plugin::check_handin(\%itemcount,1008=>1);
plugin::check_handin(\%itemcount,1009=>1);
plugin::check_handin(\%itemcount,1010=>1);
plugin::check_handin(\%itemcount,1011=>1);
plugin::check_handin(\%itemcount,1012=>1);
quest::say("OH!  Have that already?  Try this piece on for size.  ROWR!");
quest::summonitem(quest::ChooseRandom(1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012));
}
