...
if ($itemcount{31584} >= 1 || $itemcount{31589} >= 1 || $itemcount{31586} >= 1 || $itemcount{31590} >= 1 || $itemcount{31593} >= 1 || $itemcount{31594} >= 1 || $itemcount{31595} >= 1 || $itemcount{31588} >= 1 || $itemcount{31585} >= 1 || $itemcount{31592} >= 1 || $itemcount{31587}>=1  || $itemcount{31591}>= 1){
plugin::check_handin(\%itemcount,31584=>1);
plugin::check_handin(\%itemcount,31589=>1);
plugin::check_handin(\%itemcount,31586=>1);
plugin::check_handin(\%itemcount,31590=>1);
plugin::check_handin(\%itemcount,31593=>1);
plugin::check_handin(\%itemcount,31594=>1);
plugin::check_handin(\%itemcount,31595=>1);
plugin::check_handin(\%itemcount,31588=>1);
plugin::check_handin(\%itemcount,31585=>1);
plugin::check_handin(\%itemcount,31592=>1);
plugin::check_handin(\%itemcount,31587=>1);
plugin::check_handin(\%itemcount,31591=>1);
quest::say("Aha!  Have that already?  Try this piece on for size.  ROWR!");
quest::summonitem(quest::ChooseRandom(31584,31589,31586,31590,31593,31594,31595,31588,31585,31592,31587,31591));
}
