...
sub EVENT_ENTER {
  ...
  quest::spawn2(288082,0,0,1320,-2551,15,174);
  quest::spawn2(288083,0,0,1382,-2549,7,380);
  quest::spawn2(288084,0,0,1331,-2605,7,508);
  quest::spawn2(288085,0,0,1362,-2577,10,430);
  $event_started = 1;
  }
}
}
...
sub EVENT_SIGNAL {
  if($signal == 1) { #signal 1 is from each of the remains
    $counter += 1;
      if($counter == 4) {
       quest::spawn2(288087,0,0,536,-2353,-60,128);
 }
 }
 }
