...
sub EVENT_ITEM 
	...
	if ($faction < 6)
		...
		if(plugin::check_handin(\%itemcount, 16544 => 1, 16543 => 1, 16538 => 1, 10032 => 1)) 
			{ #Broom, Cyclops Toes, Griffon Feathers, Star Ruby
		...
		elsif(plugin::check_handin(\%itemcount, 10035 => 1, 10014 => 1, 16545 => 1, 16539 => 1)) 
			{ #Ruby, Gargoyle Eye, Shovel, Hill Giant Toes
		...
		elsif(plugin::check_handin(\%itemcount, 16540 => 1, 16542 => 1, 10034 => 1, 16547 => 1)) 
			{ #Ice Giant Toes, Mermaid Scale, Sapphire, Stein 
		...
		elsif(plugin::check_handin(\%itemcount, 16546 => 1, 16534 => 1, 10033 => 1, 16541 => 1)) 
			{ #Torch, Fire Drake Scale, Fire Emerald, Fire Giant Toes
		...
		elsif(plugin::check_handin(\%itemcount, 58003 => 1)) 
			{ #Vial of Liquid
