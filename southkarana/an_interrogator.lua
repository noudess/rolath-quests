...
function event_timer(e)
	...
	if(e.timer == "smack") then
		e.self:Say("Go on, give him a good smacking!");
	end

	if(e.timer == "arrive") then
		if(e.self:GetX() == -3113) then
...
function event_signal(e)
	...
	elseif(e.signal == 7) then
		eq.stop();
		eq.move_to(-3113,-5873,89,160,true);
