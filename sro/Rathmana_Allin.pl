...
quest::ding();
    ...
    quest::summonitem(quest::ChooseRandom(15022, 15035, 15038, 15039, 15303, 15328, 15355, 15364, 15445, 15300, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360, 13360));
  }
  # The Bayle List quest
    ...
    quest::say("A simple code. Why do you even bother Rathmana with such chil'ds play? Here is your translation. That was the easiest twenty gold coins I ever earned.");
