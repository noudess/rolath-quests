...
sub EVENT_ITEM
	{
	if (plugin::check_handin(\%itemcount, 20378 => 1))
		...
		quest::summonitem(20380);    #Forpar's Note to Himself
		   ...
		   plugin::check_handin(\%itemcount, 20380 => 1, 20524 => 1, 20525 => 1, 5520 => 1))
		...
		quest::say("Now, do you want to gather the next pieces for me?");
		  ...
		  plugin::check_handin(\%itemcount, 11602 => 1, 11622 => 1, 16905 => 1))
		...
		quest::summonitem(20536);    #Mystical Lute Body
		  ...
		  plugin::check_handin(\%itemcount, 20535 => 1, 20536 => 1, 20526 => 1))
