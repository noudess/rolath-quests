...
sub EVENT_SAY 
{
    if($text=~/hail/i)
    {
    quest::emote("looks down upon the creature standing beneath him and speaks. 'You are brave to approach a titan such as Prowler of the Jungle. I pray that the spirits have granted you honor and respect as well as courage.'");
    }
}
