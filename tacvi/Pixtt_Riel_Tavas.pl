...
sub EVENT_HP {
  ...
  if($hpevent == 31) {
    ...
    quest::settimer(1,60);
    quest::spawn2(298045,0,0,157,-586,-7,124);  #unstable construct
    quest::spawn2(298045,0,0,171,-553,-7,246);  
    quest::spawn2(298045,0,0,175,-619,-7,506);  
    quest::spawn2(298045,0,0,217,-589,-7,388);  
