...
sub EVENT_HP {
  ...
  if($hpevent == 51) {
    ...
    quest::spawn2(298044,0,0,145,-219,-7,414);  #juxtapincer
    quest::spawn2(298043,0,0,143,-182,-7,376);  #lifebleeder
    quest::spawn2(298042,0,0,139,-130,-7,344);  #manasipper
    quest::spawn2(298041,0,0,117,-108,-7,310);  #ragehound
