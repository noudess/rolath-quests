...
sub EVENT_ITEM {
  if($itemcount {20648} == 1) {
    quest::say("'Seek, search, turn, twist! Kazen hopes to death master truly! Read out, read in between! Talk to the pretty clouds.' Drendico turns his back to you and throws a book over his shoulder. 'Bring back book! Bring back reagents three!!' He shouts as he mumbles some more gibberish.");
    quest::ding();
    quest::exp(1000);
quest::ding();
