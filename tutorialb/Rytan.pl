...
sub EVENT_SAY
{
	if ($text=~/hail/i)
	{
		...
		quest::popup("Buffs", "Rytan is offering you a beneficial spell (a \"buff\" for short). This spell will protect you in combat.<br><br>All spells that are currently affecting you will appear in either the Effects Window or the Songs Window.<br><br><c \"#F07F00\">Respond to Rytan's dialogue in your Main Chat Window to continue.</c>");   
	}
